package com.van.demo.rabbitmq.config;

import com.van.demo.rabbitmq.receiver.DirectReceiver;
import com.van.demo.rabbitmq.receiver.DirectReceiverListener;
...
public class MessageListenerConfig {
    ...
    @Autowired
    private DirectReceiverListener directReceiver;//Direct消息接收处理类
